...
class MVCCSQL:
    ...
    def __init__(self, BDpath = 'crashes_normalized.db'):
        self.conn = sqlite3.connect(BDpath)
        self.cursor = self.conn.cursor()
        
    def delete_all_table(self):
        self.cursor.execute("DELETE FROM crashes")
        self.cursor.execute("DELETE FROM contributing_factors")
        self.cursor.execute("DELETE FROM vehicle_types")    
        self.cursor.execute("DELETE FROM streets") 
        self.conn.commit()    
        
    def drop_all_table(self):
        self.cursor.execute("DROP TABLE IF EXISTS crashes")
        self.cursor.execute("DROP TABLE IF EXISTS contributing_factors")
        self.cursor.execute("DROP TABLE IF EXISTS vehicle_types")    
    ...
    def create_table(self):
        ...
        self.cursor.execute('''
            CREATE TABLE IF NOT EXISTS crashes (
                ...
                contributing_factor_one_id INTEGER,
                contributing_factor_vehicle_1_id INTEGER,
                contributing_factor_vehicle_2_id INTEGER,
                contributing_factor_vehicle_3_id INTEGER,
                contributing_factor_vehicle_4_id INTEGER,
                contributing_factor_vehicle_5_id INTEGER,
                ...
                FOREIGN KEY (on_street_id) REFERENCES streets(id),
                FOREIGN KEY (cross_street_id) REFERENCES streets(id),
                FOREIGN KEY (off_street_id) REFERENCES streets(id),
                FOREIGN KEY (contributing_factor_vehicle_1_id) REFERENCES contributing_factors(id),
                FOREIGN KEY (contributing_factor_vehicle_2_id) REFERENCES contributing_factors(id),
                FOREIGN KEY (contributing_factor_vehicle_3_id) REFERENCES contributing_factors(id),
                FOREIGN KEY (contributing_factor_vehicle_4_id) REFERENCES contributing_factors(id),
                FOREIGN KEY (contributing_factor_vehicle_5_id) REFERENCES contributing_factors(id),
                FOREIGN KEY (vehicle_type_1_id) REFERENCES vehicle_types(id),                
                FOREIGN KEY (vehicle_type_2_id) REFERENCES vehicle_types(id),                
                FOREIGN KEY (vehicle_type_3_id) REFERENCES vehicle_types(id),                
                FOREIGN KEY (vehicle_type_4_id) REFERENCES vehicle_types(id),                
                FOREIGN KEY (vehicle_type_5_id) REFERENCES vehicle_types(id)                
            )
        ''')
